  ...
  <div class="shopcart">
    <div class="content" @click="toggleList">
      ...
      <div class="ball-container">
        <transition-group name="drop" @before-enter="beforeEnter" @enter="enter" @after-enter="afterEnter" tag="div">
...
export default {
  ...
  methods:{
    ...
    afterEnter(el){
      ...
      //小球需要0.4s的下落
      setTimeout(function(){
        let ball=_this.balls.shift();
        if(ball){
          ball.show=false;
          //el.style.display='none';
        }
        _this.balls.unshift(ball);
      },400)
    },
    toggleList(){
      if(!this.totalCount){

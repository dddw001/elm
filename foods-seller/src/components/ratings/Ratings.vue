<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <rating-selectinging :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="ratingsInfo" @ratingType="changeRatingType" @toggleContent="toggleContent"></rating-selectinging>
      <div class="rating-wrapper">
        <ul v-show="ratingsInfo&&ratingsInfo.length">
          <li v-for="rating in ratingsInfo" class="rating-item" v-show="needShow(rating.rateType,rating.text)">
            <div class="avatar">
...
const ALL=2;
export default {
  props:["sellerInfo","ratingsInfo"],
  components:{Star,RatingSelectinging,Split},
  data(){
    return{
      showFlag:false,
      selectType:ALL,
